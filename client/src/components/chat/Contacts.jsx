            ...
            return (
              <div onClick={() => {
                ...
                <div className='flex items-center gap-x-3 sm:gap-x-1 md:gap-x-3'>
                  <img className='w-12 h-12  sm:w-12 sm:h-12 rounded-[30px] shadow-lg object-cover' src={ getChatPhoto(e, activeUser) ? getChatPhoto(e, activeUser) : DefaultImage } alt='' />
                  <div>
                ...
                <div className='hidden flex flex-col items-end gap-y-[8px] sm:block'>
